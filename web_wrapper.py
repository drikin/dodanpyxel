...
def download_windows():
    ...
    with zipfile.ZipFile(memory_file, 'w') as zf:
        ...
        2. 'dodanpyxel.exe' をダブルクリックして実行します。
...
def download_mac():
    ...
    with zipfile.ZipFile(memory_file, 'w') as zf:
        ...
        ## インストール方法
        1. ダウンロードしたZIPファイルを解凍します。
        2. 'DodanPyxel.app' をダブルクリックして実行します。
